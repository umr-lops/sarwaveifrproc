...
Ready to contribute? Here's how to set up `sarwaveifrproc` for local development.

1. Fork the `sarwaveifrproc` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/sarwaveifrproc.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv sarwaveifrproc
    $ cd sarwaveifrproc/
...
$ pytest tests.test_sarwaveifrproc
